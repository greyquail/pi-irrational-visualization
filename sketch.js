// Pi irrationality epicycle (clean version)
// z(theta) = R e^(i theta) + R e^(i pi theta)
// both arms length R, permanent trail, zoom + pan, no helper circles
...
function draw() {
  ...
  // permanent trail of the tip only
  stroke(200);
  strokeWeight(1 / zoom);
  noFill();
  beginShape();
